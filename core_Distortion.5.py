...
class MainApp(QMainWindow):
    ...
    def update_rock_type_tab(self):
        ...
        # Combine log values into a feature array for clustering
        ...
        # Plot 1: log(Phi z) vs log(RQI)
        scatter1 = axes[0].scatter(log_phi_z, log_rqi, c=clusters, cmap='tab10', alpha=0.6, s=150, edgecolor='black', marker='o')
        ...
        self.current_plot_data = {
            "points1": list(zip(log_phi_z.tolist(), log_rqi.tolist())),
            "clusters1": clusters,
        }
